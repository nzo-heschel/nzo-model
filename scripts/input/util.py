class LinearInterpolation:
    ...
    def get_value(self, key):
        '''Returns the value for the given integer key'''
...
class DemandGrowth:
    def __init__(self, baseline, growth_marks_pct):
        ...
        :param growth_marks_pct: percentage grow for given years
            (last value is ignored, it used to indicate the last key)
        '''
        self._values = {}
